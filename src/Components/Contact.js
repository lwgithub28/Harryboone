...
const Contact = () => {
    ...
    const [isLastNameValidationVisible, setLastNameValidationVisible] = useState(false);
    ...
    const handleSubmit = (event) => {
        ...
        if (inputValue && LastinputValue && phoneValue && emailValue && phoneValue.length === 10 && !isNaN(phoneValue)) {
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Get in touch with Harry Boone for inquiries, commissions, or collaborations. Fill out the contact form or find contact details to reach the artist directly." />
            </Helmet>
                ...
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='col-sm-12 col-md-12 col-lg-6 img'>
                            <img src={contactus} alt='contactus' title="contactus" rel="noreferrer noopener" loading="lazy"></img>
                        </div>
                        <div className='col-sm-12 col-md-12 col-lg-6 contact-form'>
                            <form onSubmit={handleSubmit}>
                                <h1 className='main-head-contact'>YOUR INQUIRIES AND COMMENTS ARE WELCOME</h1>
                                <div className='dflex'>
                                    <span>
                                        <input
                                        ...
                                        />
                                        <div className={`validation-message ${isNameValidationVisible ? 'show' : ''}`}>
                                    ...
                                    <span>
                                        ...
                                        />
                                        <div className={`validation-message ${isLastNameValidationVisible ? 'show' : ''}`}>
                                            <p>Name is required.</p>
                                        </div>
                                    </span>
                                </div>
                                <div className='dflex form-top-spacing'>
                                    <span>
                                        ...
                                        />
                                        <div className={`validation-message ${isEmailValidationVisible ? 'show' : ''}`}>
                                    ...
                                    <span>
                                        ...
                                        />
                                        <div className={`validation-message ${isPhoneValidationVisible ? 'show' : ''}`}>
                                            {phoneValue ? <p>Phone number must be 10 digits. </p> : <p>Phone number is required.</p>}
                                        </div>
                                    </span>
                                </div>
                                ...
                                <ReCAPTCHA
                                    sitekey="6LegjOspAAAAAFQ3JmhfLKLpdtDqvtbhHQpKyZjl"
                                />
                                <div className='form-top-spacing btns'>
                                    <button type="submit">submit</button>
                                </div>
                                {isSubmittedSuccessfully && <p className='submit-succesfully'>Thank you for your message.</p>}
                            </form>
                        </div>
                    </div>
                </div>
