...
const NatureHumansAnimalsAndElements = () => {
    ...
    const data = {
        ...
        head1: "Humans",
        haed1desc: ["The major objective was to understand and express the essence of a broadly defined nature to include the human, in addition to animals and earthly elements.  The human paintings begin with both the witnessed and imagined.  An example of the former is ",
        ...
        head2: "Animals",
        haed2desc: ["Anthropomorphic depictions are sometimes a better way of calling attention to compelling aspects of human existence, the light-hearted and the grave, thus my foray into animal imagery.   The dog paintings ,",
    ...
    return (
        <>
            <Helmet>
                <title>Nature, Humans, Animals, and Elements - Harry Boone | Art Collection</title>
                <meta name="description" content="Explore the Nature, Humans, Animals, and Elements collection by Harry Boone. Delve into abstract art pieces depicting the interconnection of natural elements and beings." />
            </Helmet>
            <div className='stillLifes for-visibilty' id='stillLifes'>
                <div className='container'>
                    <div className='row'>
                        <h2 className='color-chng'> NATURE: HUMANS, ANIMALS, AND ELEMENTS</h2>
                        <p className='middle-text'> Click the thumbnails below to view full and enlarged images</p>
                        <ModalComponent {...data} />
                        <div className='modal-gallery'>
                            ...
                            {lightboxOpen && (
                                <Lightbox
                                    images={HumansAndAnimals.map(image => ({ url: image.src, title: image.title }))}
