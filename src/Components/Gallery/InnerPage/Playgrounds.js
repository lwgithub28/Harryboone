    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="View the Playgrounds collection by Harry Boone. Experience abstract paintings inspired by childhood memories and playful scenes." />
            </Helmet>
                ...
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='modal-gallery'>
                            ...
                            {lightboxOpen && (
                                <Lightbox
                                    images={playgroundData.map(image => ({ url: image.src, title: image.title }))}
