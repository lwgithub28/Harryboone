    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Discover the Coastal Places and Things collection by Harry Boone. Explore abstract paintings inspired by coastal landscapes and maritime themes." />
            </Helmet>
                ...
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='modal-gallery'>
                            ...
                            {lightboxOpen && (
                                <Lightbox
                                    images={Coastalplacesandthings.map(image => ({ url: image.src, title: image.title }))}
