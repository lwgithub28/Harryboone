...
const CoastalPlacesAndThings = () => {
    ...
    const previousImage = () => {
        ...
        setCurrentImage(prevIndex => {
            const newIndex = (prevIndex - 1 + Coastalplacesandthings.length) % Coastalplacesandthings.length;
            return newIndex;
        });
    };
                                        ...
                                        <Modal onClose={closeLightbox}>
                                            <div className="image-modal">
                                                <div className="top-header">
                                                    ...
                                                    <button onClick={previousImage} className="nav-button prev-button">
                                                ...
                                                <div className="carousel-container">
                                                    ...
                                                    <div className="caption">
                                                        <p>
                                                            {Coastalplacesandthings[currentImage].title}
                                                        </p>
