    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Browse the Interiors and Still Lifes collection by Harry Boone. Discover abstract interpretations of indoor spaces and still life compositions." />
            </Helmet>
                ...
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='modal-gallery'>
                            ...
                            {lightboxOpen && (
                                <Lightbox
                                    images={StillLifesData.map(image => ({ url: image.src, title: image.title }))}
