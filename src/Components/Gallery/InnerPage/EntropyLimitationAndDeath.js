    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Check the Limitation and Death collection by Harry Boone. Reflect on abstract paintings exploring themes of mortality and existential limits." />
            </Helmet>
                ...
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='modal-gallery'>
                            ...
                            {lightboxOpen && (
                                <Lightbox
                                    images={Entropylimitationanddeath.map(image => ({ url: image.src, title: image.title }))}
